...
function CodeBlockCombobox({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger render={<Button size="sm" variant="ghost" className="h-6 select-none justify-between gap-1 px-2 text-muted-foreground text-xs" aria-expanded={open} role="combobox" />}>{getCodeBlockLanguageLabel(value) ?? 'Plain Text'}</PopoverTrigger>
      <PopoverContent
